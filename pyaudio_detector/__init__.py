"""
AudioDeviceUID - Cross-platform Audio Device Detection Library with UID Support

Comprehensive audio input and output device detection for macOS, Windows, and Linux platforms.
